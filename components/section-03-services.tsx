...
const services: Service[] = [
  {
    ...
    desc: 'Automate repetitive tasks, streamline workflows and connect your tools to save time and reduce manual effort. From smart data entry to automated follow-ups, we build systems that work around the clock so your team can focus on what matters most.',
    icon: Cog,
  },
  {
    no: '02',
    title: 'LANDING PAGE',
    desc: 'A single, high-converting page to showcase your business and drive action. Crafted with persuasive copy, compelling visuals and strategic call-to-actions that turn visitors into leads and customers.',
    icon: Monitor,
  },
  {
    no: '03',
    title: 'WEBSITE + LOGO DESIGN',
    desc: 'Multi-page website with custom logo, brand identity and everything you need. From About and Services pages to Contact forms — we design and build a cohesive online presence that builds trust and credibility.',
    icon: PenTool,
  },
  {
    no: '04',
    title: 'E-COMMERCE WEBSITE',
    desc: 'Launch and scale your store with cart, payments, and order management. Includes product catalogs, secure checkout, inventory tracking and admin dashboards to run your online business seamlessly.',
    icon: ShoppingCart,
  },
  {
    no: '05',
    title: 'WEB & MOBILE APPS',
    desc: 'Custom web and mobile applications built for your unique business needs. Whether it is a customer-facing app or an internal tool, we deliver fast, responsive and scalable solutions from concept to deployment.',
    icon: Smartphone,
  },
  {
    no: '06',
    title: 'MANAGEMENT SYSTEMS',
    desc: 'Powerful admin panels and systems to manage your business efficiently. Track users, handle orders, generate reports and control every aspect of your operations from a single, intuitive dashboard.',
    icon: LayoutDashboard,
  },
  {
    no: '07',
    title: 'POSTER & GRAPHIC DESIGN',
    desc: 'Stunning posters, social creatives and brand assets that stand out. Eye-catching visuals designed for print and digital platforms to boost your brand recognition and social media presence.',
    icon: Palette,
  },
]
